...
> `v0.1.0`.
>
> **Проверено командами.** `make lint` — ruff check, `ruff format --check` (184 файла) и
> `mypy --strict` (154 файла) зелёные; `make test` — **677 passed, 8 skipped**, ~40 с, покрытие
...
> делался — это решение пользователя.
