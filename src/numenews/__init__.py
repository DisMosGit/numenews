...
Phases 0 to 3 are implemented so far: configuration, logging, the domain models, the pure numerology
layer, the five news sources behind one Protocol and the vector layer (local embeddings plus the
five Qdrant collections). ``ROADMAP.md`` is the phase plan.
"""
