...
arguments that produced it (``HistoryResult``, ``PatternsResult``). Every one of them is a Pydantic
model, because :func:`~numenews.cli.output.print_json` serializes models and ``AGENTS.md`` keeps
dicts out of the boundaries.
...
__all__ = ["NotImplementedReport", "VersionInfo"]
