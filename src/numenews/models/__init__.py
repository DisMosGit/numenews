...
These are the only types that cross module boundaries: news items, extracted numbers, numerology
results, patterns, forecasts and number activations. Every model is frozen and strict — validation
never coerces and an instance never changes — so a value that crossed a boundary stays what it says
it is.
